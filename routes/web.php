...
Route::controller(DMEEquipmentController::class)->group(function () {
    Route::get('/dme-equipments', 'index')->name('app.products');
    Route::get('/dme-equipments/search', 'search')->name('app.products-search');
});
